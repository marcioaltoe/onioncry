...
Add `onion/circular-dependency` by detecting cycles in the resolved local import graph. This slice should report cycles across all analyzed local files, not only cross-layer or cross-context cycles.
