# task-005: Enforce external package policy

## Description

Implement onion/no-forbidden-imports for external package imports using default-deny allowlists in sensitive layers, including domain-safe allowlists and layer-specific severities.
